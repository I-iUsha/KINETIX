...
*glTF and USD describe geometry. kinetiX describes meaning, physics, and intent.*
...
unstable stacks, blocked doors). kinetiX sits between any agent and a 3D engine and
...
that *repairs* it. Full vision: [`KINETIX_master_spec.md`](KINETIX_master_spec.md).
...
KINETIX_master_spec.md  # The full vision (reference, not the weekend scope).
