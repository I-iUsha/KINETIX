"""
kinetiX — Frozen Contracts (THE SEAM).
...
Schemas mirror KINETIX_master_spec.md §13 (Diff / Verdict), §5.5 (PAP).
"""
...
MCP_TOOLS: dict[str, str] = {
    ...
    "register_ue_asset":    "(asset_id, ue_package_path) -> dict",
    "place_asset":          "(asset_id, node_id, pos, quat, scale, space) -> dict",
    "validate_node":        "(node_id, laws_json) -> Verdict",
    "remove_node":          "(node_id) -> bool",
    "clear_forest":         "() -> dict",
    "forest_layout":        "() -> dict",
    "validate_forest":      "(laws_json) -> dict",
    "export_forest":        "(out_path) -> dict",
    # Learned placement distributions.
    "add_placement_example":"(asset_id, tag, orientation, offsets...) -> dict",
