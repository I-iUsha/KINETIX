...
import type { NodeKind, kinetiXData } from './engine'

/** Look up a node's kinetiXData by id (wraps ReactFlow's getNode). */
export type GetNodeData = (id: string) => kinetiXData | undefined
...
function typeOk(src?: kinetiXData, tgt?: kinetiXData): boolean {
