...
A project lives at ``<KINETIX_PROJECTS>/<name>/``:
...
Default dir: ``~/kinetix_projects`` (override with ``KINETIX_PROJECTS``).
"""
...
PROJ_DIR = os.environ.get("KINETIX_PROJECTS") or os.path.join(os.path.expanduser("~"), "kinetix_projects")
