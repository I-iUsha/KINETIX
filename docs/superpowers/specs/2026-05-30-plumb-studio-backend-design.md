# kinetiX Studio — Backend Playground + Bake Workbench — Design Spec
...
```
┌ menubar: ◆kinetiX │ New · Open · Import mesh ········· the_gallery.wdf · 3 assets ┐
...
- **Brand:** the real text-only kinetiX wordmark (sage `#586040`, olive bevel `#424A29`).
