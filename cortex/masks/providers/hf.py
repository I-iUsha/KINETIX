...
label by vertical band (centroid height â†’ image band). Documented as refine-later.
"""
...
def _hf_request(model: str, image_bytes: bytes):
    """The mockable network seam â€” POST an image, return the parsed JSON response."""
